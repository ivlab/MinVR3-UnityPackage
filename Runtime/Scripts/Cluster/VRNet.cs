...
namespace IVLab.MinVR3 {
    ...
    public static class VRNet {
        ...
        public static void SendEventData(ref TcpClient client, in List<VREventInstance> inputEvents) {
        ...
        public static void ReceiveEventData(ref TcpClient client, ref List<VREventInstance> inputEvents) {
