...
namespace IVLab.MinVR3
{
    ...
    [Serializable]
    public class VREventPrototypeVector3 : VREventPrototype<Vector3>
    {
    ...
    [Serializable]
    public class VRCallbackVector3 : VRCallback<Vector3>
    {
    ...
    [Serializable]
    public class VREventCallbackVector3 : VREventCallback<Vector3>
    {
