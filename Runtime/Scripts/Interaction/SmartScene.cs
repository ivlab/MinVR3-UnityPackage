...
namespace IVLab.MinVR3
{
    ...
    public class SmartScene : MonoBehaviour
    {
		...
		public void Awake()
		{
			...
			m_FSM.AddArc("Grab0", "START", VREventCallbackAny.CreateRuntime(m_Cursor0UpEvent));
			...
			m_FSM.AddArc("Grab1", "START", VREventCallbackAny.CreateRuntime(m_Cursor1UpEvent));
		...
		public void TwoHandMove(int cursorID, Vector3 pos)
		{
			...
			if (m_ManipulatingObj != null) {
				...
				m_ManipulatingObj.transform.ScaleAroundLocalPoint(pivotWorld, deltaScale);
			} else {
