...
namespace IVLab.MinVR3
{
	...
	/// 
	/// # Converting LH <-> RH: The big question is, which axis to negate?
	/// 
    ...
    public class CoordConversion
    {
        ...
        /// <summary>
        /// Converts a point or vector defined <inheritdoc/>Unity's coordinate system convention (left-handed,
        ...
        /// <summary>
        /// Converts a quaternion defined <inheritdoc/>Unity's coordinate system convention (left-handed,
        /// +Y = Up, +Z = Forward) into some new coordinate system convention.
        /// </summary>
