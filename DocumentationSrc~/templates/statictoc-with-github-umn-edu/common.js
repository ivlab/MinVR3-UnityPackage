...
var gitUrlPatternItems = {
  'github.umn.edu': {
      // HTTPS form: https://github.umn.edu/{org}/{repo}.git
      // SSH form: git@github.umn.edu:{org}/{repo}.git
      // generate URL: https://github.umn.edu/{org}/{repo}/blob/{branch}/{path}
      'testRegex': /^(https?:\/\/)?(\S+\@)?(\S+\.)?github\.umn\.edu(\/|:).*/i,
